		...
		function moveInLeftBottom(x, y, obj1, obj2, obj3) {
			...
			obj1.style.backgroundImage = "-webkit-linear-gradient(-" + (90 - obj1.x) + "deg,rgba(250,250,250,0.8) " + obj1.z + "px,rgba(250,250,250,0.5) " + obj1.z + "px,rgba(250,250,250,0) " + (obj1.z + 30) + "px,rgba(255,255,255,0) 100px)";
		...
		function moveInLeftTop(x, y, obj1, obj2, obj3) {
			...
			obj1.style.backgroundImage = "-webkit-linear-gradient(-" + (90 - obj1.x) + "deg,rgba(250,250,250,0.8) " + obj1.z + "px,rgba(250,250,250,0.5) " + obj1.z + "px,rgba(250,250,250,0) " + (obj1.z + 30) + "px,rgba(250,250,250,0) 100px)";
		...
		function moveBefore(x,obj1,obj2,obj3){
			...
			obj2.style.display = "block";
			obj1.z = x/2;
			obj1.style.backgroundImage = "-webkit-linear-gradient(right,rgba(250,250,250,0.8) " + obj1.z + "px,rgba(250,250,250,0.5) " + obj1.z + "px,rgba(250,250,250,0) " + (obj1.z + 30) + "px,rgba(250,250,250,0) 100px)";
